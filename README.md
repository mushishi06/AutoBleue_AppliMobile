...
<p><ul>
	...
	<li>"MAJ des themes de toutes les pages (homogénéisation)"</li>
	<li>"blocage de certaines page si non logguer"</li>
	<li>"Netoyage du code (indentation, commentaire inutile, ...) et des fichiers inutile"</li>
</ul></p>
